      ...
      <HeaderWrapper isToggled={isToggled}>
        <div className="profile_header">
          ...
          <div className="profile_title">
            <span className="profile_title_mbti" style={{ color: data.color }}>
              {data.name}
            </span>
...
function ProCons({ data, color }) {
  ...
  return (
    <>
      <div id="prosCons">
        <div className="profile_content_title" style={{ color }}>
          장단점
        </div>
        <ul>
          {prosCons.map((pros, idx) => (
            <li key={idx} className="pros">
              {/** 장단점 title */}
              <div className="prosTitle" style={{ color }}>
                {pros}
              </div>
              {/** 장단점 리스트 요소 */}
              <div>
      ...
      <div id="chemistry">
        ...
        <ul>
          {chemistry.map((chemistry, idx) => (
            <li key={idx}>
              {/** 궁합 title */}
              <div style={{ color }} className="chemistryTitle">
                {chemistry}
              </div>
              {/** 궁합 리스트 요소 */}
              <div>
